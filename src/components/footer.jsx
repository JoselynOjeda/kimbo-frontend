...
const socialLinks = [
  { 
    ...
    icon: <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24"><path d="M9.101 23.691v-7.98H6.627v-3.667h2.474v-1.58c0-4.085 1.848-5.978 5.858-5.978.401 0 .955.042 1.468.103a8.68 8.68 0 0 1 1.141.195v3.325a8.623 8.623 0 0 0-.653-.036c-2.648 0-2.928 1.67-2.928 3.403v1.575h3.988l-.538 3.677h-3.45v7.98h-4.996Z"></path></svg>
  },
  { 
    name: "TikTok", 
    href: "https://www.tiktok.com/@kimbodogfood", 
    icon: <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"></path></svg>
  },
  { 
    name: "Instagram", 
...
export default function Footer() {
  ...
  return (
    <footer style={footerStyles.footer}>
        ...
        <div style={footerStyles.contentWrapper}>
          ...
          <div style={footerStyles.brandSection}>
            ...
            <p style={footerStyles.brandDescription}>
              Creando nutrición real y funcional que eleva la salud de tu mascota
              y conecta contigo.
            </p>
      ...
      {/* Línea brillante decorativa al fondo */}
